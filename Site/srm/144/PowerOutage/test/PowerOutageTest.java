...
public class PowerOutageTest {
    ...
    public void test0() {
        ...
        assertEquals(10, new PowerOutage()
                .estimateTimeOut(fromJunction, toJunction, ductLength));
    }
    ...
    public void test1() {
        ...
        assertEquals(40, new PowerOutage()
                .estimateTimeOut(fromJunction, toJunction, ductLength));
    }
    ...
    public void test2() {
        ...
        assertEquals(165, new PowerOutage()
                .estimateTimeOut(fromJunction, toJunction, ductLength));
    }
    ...
    public void test3() {
        ...
        assertEquals(281, new PowerOutage()
                .estimateTimeOut(fromJunction, toJunction, ductLength));
    }
    ...
    public void test4() {
        ...
        assertEquals(2500, new PowerOutage()
                .estimateTimeOut(fromJunction, toJunction, ductLength));
    }
}
