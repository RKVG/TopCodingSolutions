...
public class MasterbrainTest {
    ...
    public void test3() {
        String[] guesses =
                new String[]{"1513", "5654", "4564", "1377", "1671", "1342"};
        String[] results =
                new String[]{"1b 0w", "0b 1w", "1b 0w", "1b 0w", "0b 1w",
                        "0b 1w"};
    ...
    public void test4() {
        String[] guesses =
                new String[]{"2611", "1371", "7417", "2647", "3735", "4272",
                        "2442", "3443", "1252", "3353"};
        String[] results =
                new String[]{"0b 2w", "0b 2w", "0b 1w", "0b 2w", "1b 0w",
                        "1b 0w", "1b 0w", "0b 1w", "1b 1w", "0b 1w"};
