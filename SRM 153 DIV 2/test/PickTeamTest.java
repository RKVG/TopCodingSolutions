...
public class PickTeamTest {
 ...
 "CAROL -1 2 0 2",
 "DAVID 3 -4 2 0"};
		assertArrayEquals(new String[] { "ALICE",  "CAROL",  "DAVID" }, new PickTeam().pickPeople(teamSize, people));
	}
 ...
 "CAROL -1 2 0 2",
 "DAVID 3 -4 2 0"};
		assertArrayEquals(new String[] { "ALICE",  "DAVID" }, new PickTeam().pickPeople(teamSize, people));
	}
	...
	public void test2() {
		...
		assertArrayEquals(new String[] { "B",  "C" }, new PickTeam().pickPeople(teamSize, people));
	}
	
	@Test(timeout=2000)
	public void test3() {
		int teamSize = 13;
		String[] people = new String[] {"A 0 2 8 7 1 -4 -3 1 8 2 8 2 1 -3 7 1 3 9 -6 -5",
 ...
 "E -5 3 -8 8 -2 -2 3 4 4 4 4 -2 -6 1 3 -7 5 8 1 0"};
		assertArrayEquals(new String[] { "A",  "A",  "B",  "B",  "B",  "B",  "C",  "C",  "C",  "D",  "D",  "D",  "E" }, new PickTeam().pickPeople(teamSize, people));
	}
}
