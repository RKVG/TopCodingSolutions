...
//			(timeout=2000)
 ...
 "CORNELL 88.0 83.7 85.0 83.8 99.8 92.1 91.0 88.9"};
		String[] results =  new ContestScore().sortResults(data);
		assertArrayEquals(new String[] { "PRINCETON 34 717.6",  "MIT 36 721.7",  "HARVARD 38 719.9",  "COLUMBIA 39 720.0",  "STANFORD 39 711.3",  "YALE 40 712.4",  "BROWN 41 720.0",  "CORNELL 42 712.3",  "PENN 51 699.5" }, results);
	}
