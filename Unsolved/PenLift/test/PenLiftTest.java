...
public class PenLiftTest {
    ...
    public void test1() {
        String[] segments =
                new String[]{"-10 0 0 0", "0 0 10 0", "0 -10 0 0", "0 0 0 10"};
        int n = 1;
        assertEquals(1, new PenLift().numTimes(segments, n));
    }
    ...
    public void test3() {
        String[] segments =
                new String[]{"0 0 1 0", "2 0 4 0", "5 0 8 0", "9 0 13 0",
    ...
    public void test4() {
        String[] segments =
                new String[]{"-2 6 -2 1", "2 6 2 1", "6 -2 1 -2", "6 2 1 2",
    ...
    @Test
    public void test5() {
        String[] segments = new String[]{"-252927 -1000000 -252927 549481",
